...
class Glm5NextTextConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # GLM53-PORT: transformers<5.16 validates layer_type entries against a
        # list that lacks "deepseek_sparse_attention"; defer the assignment to
        # after super().__init__ where the HF hub mixin's strict validation
        # does not run.
        _glm53_layer_types = layer_types
        ...
        # GLM53-PORT: see note above near _glm53_layer_types.
        self.layer_types = _glm53_layer_types
